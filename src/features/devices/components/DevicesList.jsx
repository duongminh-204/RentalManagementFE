...
import { DEVICE_STATUS_OPTIONS, DEVICE_TYPE_ICON, getStatusConfig } from '../constants';
...
const ICON_REGISTRY = {
  ...
  Table, Plug, Snowflake, ShieldCheck, Package,
};

// Đoán icon theo từ khóa trong tên thiết bị (cho thiết bị mới chưa gán icon)
const KEYWORD_ICONS = [
...
const getDeviceIcon = (device) => {
  ...
  return ICON_REGISTRY[DEVICE_TYPE_ICON[device.type]] || Package;
};
      ...
      <div className="page-content page-content--wide">
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h1 className="text-[32px] font-bold leading-tight text-ink-deep">Quản lý thiết bị</h1>
              <p className="mt-1 text-gray-500">
                Quản lý thiết bị và trạng thái thiết bị của từng phòng.
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Tìm theo tên thiết bị hoặc số phòng..."
                value={searchTerm}
          ...
          {filteredDevices.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-14 text-center">
              ...
              <p className="mt-3 font-medium text-gray-600">Chưa có thiết bị nào</p>
              <p className="text-sm text-gray-400">Nhấn "Thêm thiết bị" để bắt đầu quản lý.</p>
            </div>
          ) : (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="truncate text-xs text-gray-400">
                          Phòng {device.roomNumber} · {status.label}
                        </p>
                      </button>
