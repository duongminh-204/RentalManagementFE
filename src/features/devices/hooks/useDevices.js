...
const INITIAL_DEVICES = [
  ...
  // ===== Dịch vụ =====
  {
    ...
    icon: 'Wifi',
    price: '150000',
    description: 'Gói 150Mbps dùng chung',
  },
  {
    id: 'sv-2',
    category: 'service',
    name: 'Dọn vệ sinh khu chung',
    type: 'Vệ sinh',
    roomNumber: 'Toàn nhà',
    status: 'active',
    image: null,
  ...
  },
  {
    ...
    icon: 'Car',
    price: '100000',
    description: 'Có mái che, camera giám sát',
  },
  {
    id: 'sv-4',
    category: 'service',
    ...
    icon: 'WashingMachine',
    price: '20000',
    description: 'Máy giặt tầng 1 đang sửa',
  },
  {
    id: 'sv-5',
    category: 'service',
    name: 'Nước uống bình 20L',
    type: 'Nước uống',
    roomNumber: 'Toàn nhà',
    status: 'active',
    image: null,
    icon: 'Droplet',
    price: '12000',
    description: 'Giao tận phòng theo yêu cầu',
  },
  {
    id: 'sv-6',
    category: 'service',
    name: 'Bảo vệ trực 24/7',
    type: 'An ninh',
    roomNumber: 'Toàn nhà',
    status: 'active',
    image: null,
    icon: 'ShieldCheck',
    price: '0',
    description: 'Đã bao gồm trong tiền phòng',
  },
];
