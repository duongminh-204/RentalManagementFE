...
const RoomManagementPanel = ({
  ...
  return (
    <aside className="relative flex h-full max-h-[calc(100dvh-8rem)] min-h-[280px] flex-col overflow-hidden rounded-2xl border border-hairline-cloud bg-surface-light shadow-[var(--shadow-card)] sm:min-h-[400px] lg:min-h-[600px] xl:min-h-[640px]">
